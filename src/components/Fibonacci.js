...
import FibonacciComponent from './FibonacciCalculator'
  ...
  render() {
    ...
    return (
      <div className="fibonacci_page">
        <FibonacciComponent />
        <div>
          <button onClick={next} className="change">
            Next
          </button>
          <br />
          <br />
          ...
          <div className="fibonacci">
            <div
              className="fibonacci-item one"
              style={{ backgroundImage: `url(${images[0]})` }}
            ></div>
            <div
              className="fibonacci-item two"
              style={{ backgroundImage: `url(${images[1]})` }}
            ></div>
            <div
              className="fibonacci-item three"
              style={{ backgroundImage: `url(${images[2]})` }}
            ></div>
            <div
              className="fibonacci-item four"
              style={{ backgroundImage: `url(${images[3]})` }}
            ></div>
            <div
              className="fibonacci-item five"
              style={{ backgroundImage: `url(${images[4]})` }}
            ></div>
            <div
              className="fibonacci-item six"
              style={{ backgroundImage: `url(${images[5]})` }}
            ></div>
            <div
              className="fibonacci-item seven"
              style={{ backgroundImage: `url(${images[6]})` }}
            ></div>
            <div
              className="fibonacci-item eight"
              style={{ backgroundImage: `url(${images[7]})` }}
            ></div>
            <div
              className="fibonacci-item nine"
              style={{ backgroundImage: `url(${images[8]})` }}
            ></div>
          </div>
          <br />
          <button onClick={previous} className="change">
            Previous
          </button>
        </div>
